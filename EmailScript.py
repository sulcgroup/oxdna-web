...
try:
	EMAIL_CREDENTIALS = open("/var/www/azDNA/azDNA/AZDNALogin.txt", "r").read().split(";")
	HELP_TEXT = open("/var/www/azDNA/azDNA/EmailScriptHelp.txt", "r").read()
...
def SendEmail(args):
	...
	with open("/var/www/azDNA/azDNA/AZDNA_Email_Templates.txt", "r") as file:
